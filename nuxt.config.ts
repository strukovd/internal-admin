...
export default defineNuxtConfig({
	...
	runtimeConfig: {
		public: {
			apiURL: process.env.NUXT_PUBLIC_REPORT_HANDLER_API_BASE ?? 'https://api.gazprom.kg/api',
			meterAppApiURL: process.env.NUXT_PUBLIC_METER_APP_API_BASE ?? 'https://api.gazprom.kg/api',
