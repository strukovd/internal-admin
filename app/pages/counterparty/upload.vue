<template>
	<section class="upload">
		<BaseBreadcrumbs :breadcrumbs="[{ title: 'Главная', link: '/' }, { title: 'Абоненты', link: '/clients' }, { title: 'Загрузка абонентов' }]"/>
		<BaseIsland title="Загрузка абонентов" prependIcon="mdi-upload">
			<form class="upload-form" @submit.prevent="sendForm">
...
const uploadEndpoint = '/counterparty/create/file';
