<template>
	<section class="upload-balances">
		<BaseBreadcrumbs :breadcrumbs="[{ title: 'Главная', link: '/' }, { title: 'Абоненты', link: '/clients' }, { title: 'Загрузка балансов' }]"/>
...
const uploadEndpoint = '/counterparty/balance/file';
