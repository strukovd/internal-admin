<template>
	<section class="upload-readings">
		<BaseBreadcrumbs :breadcrumbs="[{ title: 'Главная', link: '/' }, { title: 'Абоненты', link: '/clients' }, { title: 'Загрузка показаний' }]"/>
		<BaseIsland title="Загрузка показаний" prependIcon="mdi-upload">
			<form class="upload-readings-form" @submit.prevent="sendForm">
...
const uploadEndpoint = '/counterparty/readings/file';
