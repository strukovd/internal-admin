<template>
	<section class="bills-upload">
		<BaseBreadcrumbs :breadcrumbs="[{ title: 'Главная', link: '/' }, { title: 'Онлайн квитанции' }]"/>
		<BaseIsland title="Онлайн квитанции" prependIcon="mdi-upload">
			<form class="bills-upload-form" @submit.prevent="sendForm">
				...
				<BaseCheckbox v-model="form.saveBalance" label="Сохранить баланс" />
...
const uploadEndpoint = '/bills/file';
